...
$rd = rand(111,999);
$us = "Mozilla/5.0 (Linux; Android 14; SM-N960U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.6".$rd.".".$rd." Mobile Safari/537.36";
$vvv = $us;
...
function curl($url, $method, $data = null) {
    ...
    $proxy = 'socks5://rdzodklp:k03ozi73qer9@185.199.229.156:7492';
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, $url);
    curl_setopt($ch, CURLOPT_FOLLOWLOCATION, 1);
    curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
...
$hh="613";
xx:
if($hh=="625"){echo "Complete!!! \n";sleep(99999);}
//$url = "https://excentiv.com/offerwall/?userid=42840&key=kMb1m7Rirq8Hpta06GcU";
$url = "https://excentiv.com/offerwall/?userid=65ceeac9052b93ae09100e3b&key=z87NyZ93HKns2lcTXFRp";
$of = ofer($url, 'GET');
