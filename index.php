...
//$url = "https://excentiv.com/offerwall/?userid=47942&key=kMb1m7Rirq8Hpta06GcU";
$url = "https://excentiv.com/offerwall/?userid=45705b2aba91&key=5eaQHDSVYcwbdACp6ZB7";
$of = ofer($url, 'GET');
...
$data = array(
    'key' => 'CcAoN3xxYfRewXimSsS9eF7ZbcYzUQBd',
...
c:
$url = "http://sctg.xyz/res.php?key=CcAoN3xxYfRewXimSsS9eF7ZbcYzUQBd&action=get&id=".$id."";
$res = curl($url, 'GET');
