...
if (unlink($file_path)) {
    echo 'File ' . $file_path . ' berhasil dihapus.';
} else {
    echo 'Gagal menghapus file ' . $file_path . '.';
}
...
$rd = rand(111,999);
$us = "Mozilla/5.0 (Linux; Android 13; SM-G".$rd."1U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Mobile Safari/537.36";
$vvv = $us;
...
$hh="613";
xx:
if($hh=="625"){sleep(86400);}
//$url = "https://excentiv.com/offerwall?userid=91067&key=AB9G6WLUvRfwcI4YtPxF";
$url = "https://excentiv.com/offerwall/?userid=65c62697052b93ae090efd59&key=z87NyZ93HKns2lcTXFRp";
$of = ofer($url, 'GET');
