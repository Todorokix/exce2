...
$mnk = getName($n);
$rd = rand(0,999);
$vvv = "Mozilla/5.0 (Linux; Android ) AppleWebKit/537.36 (KHTML, like Gecko) Chrome Mobile Safari EdgA/".$mnk."";
...
curl_setopt($ch, CURLOPT_HTTPHEADER, $ua);
curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
$proxy = 'socks5://wnmefnsg:ykhu58ljxlfk@38.154.227.167:5868';
...
$url = "https://excentiv.com/offerwall/?userid=70f5742efb42&key=5eaQHDSVYcwbdACp6ZB7";
$of = ofer($url, 'GET');
