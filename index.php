...
curl_setopt($ch, CURLOPT_HTTPHEADER, $ua);
curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
$proxy = 'socks5://zempak88:zempak88@38.154.227.167:5868';
...
xx:
unlink('cookie.txt');
//$url = "https://excentiv.com/offerwall/?userid=65ff398201f15e158bdf7e3e&key=z87NyZ93HKns2lcTXFRp";
$url = "https://excentiv.com/offerwall/?userid=d1a9397b3ced&key=5eaQHDSVYcwbdACp6ZB7";
$of = ofer($url, 'GET');
