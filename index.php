...
$rd = rand(0,999);
$vvv = "Mozilla/5.0 (Windows NT 6.3; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.135 Safari/537.36 Edge/12.10240/".$rd."";
...
function solveCaptcha(){
	global $vvv, $sit;
a:
$login = "http://sctg.xyz/in.php?key=sryKi9OUWF4Rfrl7w7oplqmk5QhRWosR|onlyxevil&method=userrecaptcha&googlekey=".$sit."&json=1&pageurl=https://coins-battle.com/game/claimreward";
$ua[] = "User-Agent: ".$vvv."";
...
if($id==''){goto a;}
c:
$url = "http://sctg.xyz/res.php?key=sryKi9OUWF4Rfrl7w7oplqmk5QhRWosR|onlyxevil&action=get&id=".$id."";
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, $url);
curl_setopt($ch, CURLOPT_FOLLOWLOCATION, true);
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
...
$hh="617";
xx:
$url = "https://excentiv.com/offerwall/?userid=65fbfdde01f15e158bdf0c9e&key=z87NyZ93HKns2lcTXFRp";
//$url = "https://excentiv.com/offerwall/?userid=70042&key=r9PTEuXhlgGsd06FpAHi";
$of = ofer($url, 'GET');
