...
$xc = rand(1,200);
$ipp = "124.106.9.".$xc."";
$ar= array("2957ded8262f","e5cfd39424ff","27b2485eed06","c98283105579");
$use = $ar[$bb];
...
while(true):
$url = "https://coins-battle.com/game/play/2";
$btc = batt($url, 'GET');
