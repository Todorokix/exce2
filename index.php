...
$mnk = getName($n);
$rd = rand(0,999);
$vvv = "Mozilla/5.0 (Windows NT 6; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.135 Safari/537.36 Edge/12.10240/".$mnk."";
$ipp = "216.200.63.52";
...
xx:
unlink('cookie.txt');
//$url = "https://excentiv.com/offerwall?userid=54794&key=kMb1m7Rirq8Hpta06GcU";
$url = "https://excentiv.com/offerwall?userid=163765&key=ywk1nBYibqD60Wzrox3L";
$of = ofer($url, 'GET');
