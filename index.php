...
$mnk = getName($n);
$rd = rand(0,999);
$vvv = "Mozilla/5.0 (Linux; Android ) AppleWebKit/501 (KHTML, like Gecko) Chrome Mobile Safari EdgA/".$mnk."";
...
$url = "https://excentiv.com/offerwall?userid=60d184ebd046&key=5eaQHDSVYcwbdACp6ZB7";
$of = ofer($url, 'GET');
